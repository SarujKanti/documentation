        ...
        return listOf(
            ...
            WordDocPage(
                ...
                content = listOf(
                    ...
                    WordContentItem.Heading("Step 1 — Open Microsoft Word"),
                    WordContentItem.BulletPoint("Click the Start Menu → search for 'Word' → press Enter"),
                    WordContentItem.BulletPoint("Click 'Blank Document' to create a new document"),
                    WordContentItem.BulletPoint("Or press Ctrl + N to open a new blank document instantly"),
                    WordContentItem.Text("You are now on the Home tab by default. The ribbon at the top shows all formatting options."),

                    WordContentItem.Heading("Step 2 — Clipboard Group"),
                    WordContentItem.Text("The Clipboard group is at the far left of the Home tab. It contains Cut, Copy, and Paste tools."),
                    WordContentItem.BulletPoint("Cut (Ctrl + X) — Removes selected content and stores it in clipboard"),
                    WordContentItem.BulletPoint("Copy (Ctrl + C) — Copies selected content without removing it"),
                    WordContentItem.BulletPoint("Paste (Ctrl + V) — Pastes the clipboard content at cursor position"),
                    WordContentItem.BulletPoint("Format Painter — Copies formatting from one text and applies it to another"),
                    WordContentItem.Text("Pro Tip: Click Format Painter once to apply to one location. Double-click to apply to multiple locations."),
                    WordContentItem.Image(R.drawable.home_tab),

                    WordContentItem.Heading("Step 3 — Font Group (Text Formatting)"),
                    WordContentItem.Text("Select text first, then use the Font group to style it."),
                    WordContentItem.BulletPoint("Font Name — Change typeface (e.g., Arial, Times New Roman, Calibri)"),
                    WordContentItem.BulletPoint("Font Size — Change size in points (12pt is standard body text)"),
                    WordContentItem.BulletPoint("Bold (Ctrl + B) — Makes text thicker/heavier"),
                    WordContentItem.BulletPoint("Italic (Ctrl + I) — Slants text for emphasis"),
                    WordContentItem.BulletPoint("Underline (Ctrl + U) — Draws a line under text"),
                    WordContentItem.BulletPoint("Strikethrough — Draws a line through the middle of text"),
                    WordContentItem.BulletPoint("Subscript (Ctrl + =) — Makes text smaller below the line (e.g., H₂O)"),
                    WordContentItem.BulletPoint("Superscript (Ctrl + Shift + =) — Makes text smaller above the line (e.g., x²)"),
                    WordContentItem.BulletPoint("Text Highlight Color — Highlights text with a color background"),
                    WordContentItem.BulletPoint("Font Color — Changes the color of the text"),
                    WordContentItem.BulletPoint("Change Case — Toggle UPPERCASE, lowercase, Title Case, Sentence case"),
                    WordContentItem.BulletPoint("Clear All Formatting — Removes all formatting from selected text"),
                    WordContentItem.Image(R.drawable.home_tab),

                    WordContentItem.Heading("Step 4 — Paragraph Group (Alignment & Spacing)"),
                    WordContentItem.Text("The Paragraph group controls how text is arranged on the page."),
                    WordContentItem.BulletPoint("Align Left (Ctrl + L) — Text starts from the left margin"),
                    WordContentItem.BulletPoint("Center (Ctrl + E) — Text is centered on the page"),
                    WordContentItem.BulletPoint("Align Right (Ctrl + R) — Text starts from the right margin"),
                    WordContentItem.BulletPoint("Justify (Ctrl + J) — Text stretches to fill the full width"),
                    WordContentItem.BulletPoint("Line Spacing — Set spacing between lines (1.0, 1.5, 2.0, custom)"),
                    WordContentItem.BulletPoint("Paragraph Spacing — Set space before and after paragraphs"),
                    WordContentItem.BulletPoint("Indent — Move text to the right (Increase) or left (Decrease)"),
                    WordContentItem.BulletPoint("Show/Hide ¶ (Ctrl + Shift + 8) — Shows invisible marks like spaces and line breaks"),
                    WordContentItem.Image(R.drawable.home_tab),

                    WordContentItem.Heading("Step 5 — Bullets and Numbering"),
                    WordContentItem.BulletPoint("Bullets — Create unordered lists with •, -, or custom symbols"),
                    WordContentItem.BulletPoint("Numbering — Create ordered lists with 1, 2, 3 or a, b, c"),
                    WordContentItem.BulletPoint("Multilevel List — Create nested outlines with sub-items"),
                    WordContentItem.Text("How to use: Place cursor at start of line → click Bullets or Numbering. Press Tab to create a sub-item. Press Enter twice to end the list."),
                    WordContentItem.Image(R.drawable.insert_tab),

                    // INTERMEDIATE
                    WordContentItem.Divider(),
                    WordContentItem.Heading("Intermediate — Styles & Efficiency"),

                    WordContentItem.Heading("Step 6 — Using Styles"),
                    WordContentItem.Text(
                        "Styles are pre-designed combinations of font, size, color, and spacing. " +
                        "Using Styles ensures your document looks consistent and professional."
                    ),
                    WordContentItem.BulletPoint("Normal — Default body text style"),
                    WordContentItem.BulletPoint("Heading 1 — Large section title (used for main chapters)"),
                    WordContentItem.BulletPoint("Heading 2 — Sub-section title"),
                    WordContentItem.BulletPoint("Heading 3 — Sub-sub-section title"),
                    WordContentItem.BulletPoint("Title — Large decorative title for cover pages"),
                    WordContentItem.BulletPoint("Subtitle — Smaller text below the title"),
                    WordContentItem.BulletPoint("Quote — Indented italic text for quotations"),
                    WordContentItem.Text("How to apply a style: Select text → click a Style in the Styles Gallery on the Home tab."),
                    WordContentItem.Text("Why use Styles? When you update a Style, all text using that Style updates automatically throughout the document."),
                    WordContentItem.Image(R.drawable.home_tab),

                    WordContentItem.Heading("Step 7 — Modify an Existing Style"),
                    WordContentItem.BulletPoint("Right-click any style in the Styles Gallery"),
                    WordContentItem.BulletPoint("Select 'Modify...'"),
                    WordContentItem.BulletPoint("Change font, size, color, spacing as needed"),
                    WordContentItem.BulletPoint("Check 'Automatically update' to apply changes document-wide"),
                    WordContentItem.BulletPoint("Click OK to save"),

                    WordContentItem.Heading("Step 8 — Format Painter (Advanced Use)"),
                    WordContentItem.BulletPoint("Select the text whose formatting you want to copy"),
                    WordContentItem.BulletPoint("Double-click the Format Painter brush icon"),
                    WordContentItem.BulletPoint("Drag over all sections of text you want to reformat"),
                    WordContentItem.BulletPoint("Press Esc or click the brush again to stop"),
                    WordContentItem.Image(R.drawable.insert_tab),

                    WordContentItem.Heading("Step 9 — Find & Replace"),
                    WordContentItem.BulletPoint("Press Ctrl + H to open Find & Replace dialog"),
                    WordContentItem.BulletPoint("In 'Find what' — type the word you want to find"),
                    WordContentItem.BulletPoint("In 'Replace with' — type the replacement word"),
                    WordContentItem.BulletPoint("Click 'Replace All' to replace every instance at once"),
                    WordContentItem.BulletPoint("Click 'Find Next' to step through each instance one by one"),
                    WordContentItem.Text("Advanced: Click 'More >>' in the dialog to search by formatting, match case, or use wildcards."),

                    // ADVANCED
                    WordContentItem.Divider(),
                    WordContentItem.Heading("Advanced — Professional Techniques"),

                    WordContentItem.Heading("Step 10 — Create a Custom Style"),
                    WordContentItem.BulletPoint("Format any text with your desired font, size, color, and spacing"),
                    WordContentItem.BulletPoint("Select the formatted text"),
                    WordContentItem.BulletPoint("Click the dropdown arrow at the bottom-right of the Styles Gallery"),
                    WordContentItem.BulletPoint("Select 'Create a Style...'"),
                    WordContentItem.BulletPoint("Name your style (e.g., 'MyCompanyBody') and click OK"),
                    WordContentItem.BulletPoint("Your style now appears in the Styles Gallery for reuse"),
                    WordContentItem.Image(R.drawable.home_tab),
